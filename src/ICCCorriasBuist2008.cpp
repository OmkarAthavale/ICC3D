...
#include "ICCCorriasBuist2008.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
using namespace std;
    ...
    double CellICCCorriasBuist2008FromCellML::Get_ICC_Membrane__Cm()
    {
        return var_ICC_Membrane__Cm;
    }
    
    double CellICCCorriasBuist2008FromCellML::Get_chaste_interface__i_ionic()
    {
        return var_chaste_interface__i_ionic;
    }
    
    CellICCCorriasBuist2008FromCellML::CellICCCorriasBuist2008FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                22,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellICCCorriasBuist2008FromCellML>::Instance();
        Init();
	...
	this->mParameters[3] = 0.0;
	this->mParameters[4] = 0.1;
	////////////////////////////////////////////////
    }
    
    CellICCCorriasBuist2008FromCellML::~CellICCCorriasBuist2008FromCellML()
    {
    }
    
    void CellICCCorriasBuist2008FromCellML::VerifyStateVariables()
    {
        
    }
    
    double CellICCCorriasBuist2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellICCCorriasBuist2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Time__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
...
template<>
void OdeSystemInformation<CellICCCorriasBuist2008FromCellML>::Initialise(void)
{
    ...
    this->mParameterNames.push_back("passed_threshold");
    this->mParameterUnits.push_back("dimensionless");    

    this->mParameterNames.push_back("time_step");
    this->mParameterUnits.push_back("dimensionless");
...
CHASTE_CLASS_EXPORT(CellICCCorriasBuist2008FromCellML)
