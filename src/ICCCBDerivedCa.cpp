...
using namespace std;
    ...
    double ICCCBDerivedCa::Get_chaste_interface__ICC_Membrane__Ca_i()
    {
        return var_chaste_interface__ICC_Membrane__Ca_i;
    }

    double ICCCBDerivedCa::Get_ICC_Membrane__Cm()
    {
        return var_ICC_Membrane__Cm;
    }
    
    double ICCCBDerivedCa::Get_chaste_interface__i_ionic()
    {
        return var_chaste_interface__i_ionic;
    }
    
    ICCCBDerivedCa::ICCCBDerivedCa(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                22,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<ICCCBDerivedCa>::Instance();
        Init();
    ...
    ICCCBDerivedCa::~ICCCBDerivedCa()
    {
    }
    
    void ICCCBDerivedCa::VerifyStateVariables()
    {
        
    }
    
    double ICCCBDerivedCa::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void ICCCBDerivedCa::EvaluateYDerivatives(double var_chaste_interface__Time__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
   ...
   std::vector<double> ICCCBDerivedCa::ComputeDerivedQuantities(double var_chaste_interface__Time__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__ICC_Membrane__Ca_i = rY[1];
...
template<>
void OdeSystemInformation<ICCCBDerivedCa>::Initialise(void)
{
    ...
    this->mVariableNames.push_back("Ca_intr");
...
CHASTE_CLASS_EXPORT(ICCCBDerivedCa)
