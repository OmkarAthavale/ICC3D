#ifndef ICCCBDerivedCa_HPP_
#define ICCCBDerivedCa_HPP_
...
class ICCCBDerivedCa : public AbstractCardiacCell
{
...
public:
    ...
    ICCCBDerivedCa(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~ICCCBDerivedCa();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const ICCCBDerivedCa * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, ICCCBDerivedCa * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)ICCCBDerivedCa(p_solver, p_stimulus);
        }
