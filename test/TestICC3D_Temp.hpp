...
// *************************** TEST ************************************* //
class TestICC3D_Temp : public CxxTest::TestSuite
{
public:
 ...
 // Setting Attributes
        ...
        HeartConfig::Instance()->SetSimulationDuration(500); //ms for one cycle 10,000
		...
		// Set outputfile name
        HeartConfig::Instance()->SetOutputDirectory("TestMesh3D_ICCDummyBath_500ms_dt10ms");
