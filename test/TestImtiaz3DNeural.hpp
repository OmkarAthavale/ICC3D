...
public:
...

    {
        ...
        if (setICCNode.find(index) != setICCNode.end())
        {
            ...
            SingleModParam excitatory_neural(new ModifiableParams("excitatory_neural", 0.0001, 5000, 5000,  excitatory.GetValueOverTime(x, y, 1), "Beta_Zhang2011"));
            SingleModParam inhibitory_neural(new ModifiableParams("inhibitory_neural", 1.15, 5000, 5000,  inhibitory.GetValueOverTime(x, y, 1), "GBKmax_Kim2003"));
