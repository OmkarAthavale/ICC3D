...
// *************************** TEST ************************************* //
class TestICC3D_SaveLoad : public CxxTest::TestSuite
{
public:
    ...
    void TestMesh3D() //throw(Exception)
    {
        ...
        // 'ORIGINAL' Mesh:
        //TrianglesMeshReader<3,3> reader("projects/ICC_Test/mesh/icc-nonicc-bath.1");
 ...
 // Setting Attributes
        ...
        HeartConfig::Instance()->SetOdePdeAndPrintingTimeSteps(0.1, 1, 1); //timesteps: ode, pde, printing
		...
		// Set outputfile name
        HeartConfig::Instance()->SetOutputDirectory("TestMesh3D_ICCDummyBath_dt1ms");
        ...
        // Switch on the output into log. For writing into file use "scons test-suite=<whatever> | tee output.txt"
				CardiacSimulationArchiver<BidomainProblem<3> >::Save(bidomain_problem, "TestMesh3D_ICCDummyBath_dt1ms/saved_simulation");
    }

	void TestMesh3DSolve()
    {
        BidomainProblem<3>* p_bidomain_problem = CardiacSimulationArchiver<BidomainProblem<3> >::Load("TestMesh3D_ICCDummyBath_dt1ms/saved_simulation");
        HeartConfig::Instance()->SetSimulationDuration(150); //ms
				//HeartConfig::Instance()->SetOutputDirectory("TestMesh3D_ICCDummyBath_dt1ms");
        ...
        p_bidomain_tissue->SetConductivityModifier( &modifier );
				...
				//CardiacSimulationArchiver<BidomainProblem<3> >::Save(* p_bidomain_problem, "TestMesh3D_ICCDummyBath_dt1ms_1-100ms/solutions");
